...
model.compile(optimizer=optimizers.Adam(), loss=losses.mean_squared_error) #Metrics?

history = model.fit(input, expected_output, batch_size=input.shape[0], epochs=num_epochs)
